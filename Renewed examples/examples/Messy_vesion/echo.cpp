...
int main()
{
    ...
    pthread_t webAppThread, RFIDThread, gameThread;

    pthread_create(&webAppThread, NULL, webAppFunc, &webAppMq);
    pthread_create(&RFIDThread, NULL, RFIDFunc, &RFIDMq);
    pthread_create(&gameThread, NULL, gameFunc, &gameMq);
